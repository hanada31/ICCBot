...
-classpath $D/bin:$D/lib/jasminclasses.jar:$D/lib/sootclasses.jar:$D/lib/polyglotclasses-1.3.5.jar:$D/lib/AXMLPrinter2.jar:$D/lib/guava-14.0.1.jar:$D/lib/baksmali-2.0.3.jar:$D/lib/baksmali-1.3.2.jar:$D/google-gson-2.2.4/gson-2.2.4.jar:$D/lib/velocity-1.7-dep.jar \
presto.android.Main \
-project $ProjectDir \
-android $PlatformJar \
...
-ccfgSpecFile $D/ccfg.xml \
-modelSpecFile $D/models.xml \
$SootAndroidOptions
