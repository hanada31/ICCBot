...
import com.iscas.iccbot.analyze.model.labeledOracleModel.IccTag;
import com.iscas.iccbot.analyze.model.labeledOracleModel.IccTagCount;
...
public class ATGModel {
    ...
    public double evaluateFalseNegative(String tag) {
        ...
        if (!f.exists())
            FileUtils.writeText2File(MyConfig.getInstance().getResultWrapperFolder() + File.separator + "tagResult.txt", "\t\t" + counter.getTitle() + "\n",
                    true);
        if (isExist())
            FileUtils.writeText2File(MyConfig.getInstance().getResultWrapperFolder() + File.separator + "tagResult.txt", Global.v().getAppModel()
                    .getAppName()
    ...
    public void countTagForOracle() {
        ...
        if (!f.exists())
            FileUtils.writeText2File(MyConfig.getInstance().getResultWrapperFolder() + File.separator + "tagResult.txt", "\t\t" + counter.getTitle() + "\n", true);
        if (isExist())
            FileUtils.writeText2File(MyConfig.getInstance().getResultWrapperFolder() + File.separator + "tagResult.txt", Global.v().getAppModel().getAppName()
    ...
    private void modifyTagCounter(IccTagCount counter, String key) {
        ...
        if (iccTag.isWrapperSendICC())
            counter.isWrapperSendICC += 1;
    ...
    /**
     * @param aTGFilePath the aTGFilePath to set
     */
    ...
    /**
     * @param falsenegativeScore the falsenegativeScore to set
     */
    ...
    /**
     * @param oracleEdgeSize the oracleEdgeSize to set
     */
    ...
    /**
     * @param fnEdgeSize the fnEdgeSize to set
     */
    ...
    /**
     * @param enhancedNum the enhancedNum to set
     */
    ...
    /**
     * @param filteredNum the filteredNum to set
     */
    ...
    /**
     * @param filteredServiceNum the filteredServiceNum to set
     */
    ...
    /**
     * @param filteredReceiverNum the filteredReceiverNum to set
     */
