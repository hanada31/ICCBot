...
public class MainClass {
	...
	private static Options getOptions() {
		...
		options.addOption("callgraphAlgorithm", true, "-callgraphAlgorithm [default:CHA]: Set algorithm for CG, CHA or SPARK.");
...
//		}
	...
	private static void testConfig() {
		...
		MyConfig.getInstance().setMaxFunctionExpandNumber(30); //10?
